...
<div class="info-box bg-blue">
	...
	<div class="info-box bg-orange">
		...
		<div class="info-box bg-maroon">
			...
			<div class="info-box bg-red">
				...
				<div class="info-box-content">
					<span class="info-box-text">{{$room->transaction->guest->name}}</span>
					<span class="info-box-number">{{$room->room_no}}</span>
					<div class="progress">
													<div class="progress-bar" style="width: 100%"></div>
												</div>
												<span class="progress-description">
													<a href="{{ url('admin/'.$title.'/edit/'.$room->transaction->id) }}" style="color: white;">
		...
		@empty
		<h4 class="text-center"><b>Sorry!! <br> For a while, No Guests Will Check Out. </b> </h4>
		@endforelse
	</div>
</div>
</div>
